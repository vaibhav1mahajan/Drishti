...
const Login: React.FC = () => {
  ...
  const handleSocialLogin = (provider: string) => {
    alert(`Logging in with ${provider} (mock)`); // Replace with real OAuth logic
  };
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-950 text-white px-4 relative">
      ...
      >
        ...
        {/* Forgot Password */}
        <p
          className="text-gray-400 text-sm text-right cursor-pointer hover:underline"
        ...
        <div className="flex flex-col gap-3 mt-2">
          <motion.button
            ...
            className="flex items-center justify-center gap-2 bg-white text-black py-2 rounded-md transition font-semibold"
          >
            <FcGoogle size={18} />
          ...
          <motion.button
            ...
            className="flex items-center justify-center gap-2 bg-blue-700 hover:bg-blue-800 py-2 rounded-md transition font-semibold"
          >
            <FaMicrosoft size={18} />
          ...
          <motion.button
            ...
            className="flex items-center justify-center gap-2 bg-gray-700 hover:bg-gray-600 py-2 rounded-md transition font-semibold"
          >
            <FaGithub size={18} />
